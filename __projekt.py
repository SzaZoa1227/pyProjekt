...
def alapmuveletek():
    ...
    while nemjo:
        try:
            b = int(
                input("Add meg a második számot amivel elvégezzük a műveleteket:    "))
            nemjo = 0
        except ValueError:
            print("Számot adj meg!")
    osszeg = a+b
    ...
    while megyaprogram:
        ...
        if kezdes == 4:
            ...
            while nemjo:
                try:
                    ablakMeret = int(
                        input("Kérlek adj meg egy ablakméretet!    "))
                    nemjo = False
                except ValueError:
                    print("Egész számot adj meg!")
            # NEM TUDJA KEZELNI HA SÍMÁN INT ÉRTÉKET ADOK NEKI, LISTA KELL VAGY TUPLE MI EZ AFÉDJÉFKLJADSFÉLJDASÉFLKDJAFÉLKADSFJÉLKDSAFJÉADS
